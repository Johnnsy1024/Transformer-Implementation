...
# transformerimplementation documentation build
...
from transformerimplementation import __version__ as release

# -- Project information -----------------------------------------------------

project = "transformerimplementation"
author = "Kedro"
...
htmlhelp_basename = "transformerimplementationdoc"
...
latex_documents = [
    (
        master_doc,
        "transformerimplementation.tex",
        "transformerimplementation Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "transformerimplementation",
        "Project transformerimplementation codebase.",
        "Data-Science",
    )
]
